...
> **⚠️ 文档状态：已整合到主技术方案（2025-12）**
>
> 本文档的核心设计已整合到以下位置：
> - **用户认证**：`技术方案.md` §5.7.4 接口认证（H5 主路径 JWT Token）
> - **用户表设计**：`数据库设计.md` §5.1 wechat_user 表
> - **会员同步**：`技术方案.md` §5.1 用户旅程（MemberSyncService 相关）
>
> **说明**：本文件不再更新，如有差异以上述 SSOT 文档为准。
