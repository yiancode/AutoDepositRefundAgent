...
| 状态 | 说明 | 处理方式 |
|------|------|----------|
| **已匹配** (matched) | 系统自动匹配成功或用户主动绑定 | 无需处理 |
| **待匹配** (pending) | 等待用户绑定或系统智能匹配 | 可手动匹配 |
| **匹配失败** (failed) | 智能匹配置信度过低 | 需手动匹配 |
...
- [接口文档](./接口文档.md) - API技术详情
- [数据库设计](./数据库设计.md) - 数据结构说明
- [状态枚举定义](./状态枚举定义.md) - 状态值标准
