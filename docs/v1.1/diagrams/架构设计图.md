...
| MatchService | 身份匹配算法 | MemberMapper, OrderMapper |
| RefundService | 退款流程处理 | RefundMapper, WechatPayManager |
...
| WechatPayManager | 微信支付 API 调用 | 企业微信支付 |
