...
| POST | /payments/bind | 用户绑定星球信息 | 否 |
| GET | /payments/{orderNo}/qrcode | 获取群二维码 | 否 |
| GET | /progress/{memberId} | 查询打卡进度 | 否 |
...
```bash
GET /api/h5/payments/CAMP_1730000000_ABC123/status
```
...
```bash
GET /api/h5/payments/CAMP_1730000000_ABC123/qrcode
```
