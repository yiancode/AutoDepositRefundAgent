...
| **Epic ID** | EP02 |
| **Epic 名称** | 会员报名与支付 |
| **业务目标** | 实现支付绑定混合方案（动态二维码 + 固定二维码 + 支付后绑定） |
| **涉及角色** | 会员 |
| **优先级** | P0 |
...
- [技术方案 v1](../技术方案.md) - 第5.3节：支付与绑定混合方案
- [接口文档 v1](../接口文档.md) - 第2章：OAuth授权，第3章：H5会员端接口
- [数据库设计 v1](../数据库设计.md) - payment_record、wechat_user、user_planet_binding表
- [FastAuth接入方案](../FastAuth接入方案.md) - OAuth实现细节
- [设计优化决策文档](../设计优化决策文档.md) - P0-1, P0-2, P1-4
