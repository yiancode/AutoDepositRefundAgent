...
> **文档版本**: v1.1
> **最后更新**: 2025-12-06
> **SSOT引用**: [状态枚举定义.md](./状态枚举定义.md) - 涉及 bind_status、pay_status 等状态在前端的展示
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { title: '会员详情', roles: ['admin', 'manager'] }
      },
      {
        path: 'refunds',
        name: 'RefundManage',
      ...
      },
      {
        ...
        name: 'RefundApprove',
        component: () => import('@/views/refunds/RefundApprove.vue'),
...
- [状态枚举定义](./状态枚举定义.md) - **SSOT**: 前端展示的状态枚举值
- [技术方案](./技术方案.md) - §5.5 前端设计概述
- [API设计规范](./API设计规范.md) - 接口响应格式
...
| 版本 | 日期 | 变更内容 |
|------|------|----------|
| v1.1 | 2025-12-06 | 添加 SSOT 引用，修复文档链接，添加版本信息 |
