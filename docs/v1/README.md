...
| [设计优化决策文档.md](./设计优化决策文档.md) | 架构/流程决策索引（P0-P3） | 9KB |
...
| [OAuth绑定完整时序图.md](./security/OAuth绑定完整时序图.md) | OAuth 到支付绑定 77 步时序 | 16KB |
...
| 文档 | 用途 | 大小 |
|------|------|------|
| [AI辅助敏捷开发计划.md](./guides/AI辅助敏捷开发计划.md) | Stage 划分 + AI 提示词 | 42KB |
| [开发前准备清单.md](./guides/开发前准备清单.md) | 环境配置 + 工具安装 | 39KB |
| [Stage1-支付闭环实施指南.md](./guides/Stage1-支付闭环实施指南.md) | Stage 1 详细实施计划 | 10KB |
| [监控指标体系.md](./guides/监控指标体系.md) | 5 层监控指标 + 告警策略 | 10KB |
| [缓存策略与性能优化.md](./guides/缓存策略与性能优化.md) | Redis 缓存 + 数据库优化 | 10KB |
| [管理后台操作指南.md](./guides/管理后台操作指南.md) | 后台使用说明 | 10KB |
...
| [EP04-身份匹配.md](./user-stories/EP04-身份匹配.md) | 智能匹配 | ✅ 完成 |
...
| 文档 | 说明 |
|------|------|
| [优化完成总结.md](./archive/优化完成总结.md) | 历史优化记录与决策索引 |
...
| **OAuth 时序** | `security/OAuth绑定完整时序图.md` | 其他文档引用章节 |
| **支付安全** | `security/支付安全增强方案.md` | 其他文档引用章节 |
| **API 规范** | `design/API设计规范.md` | 其他文档引用章节 |
| **监控指标** | `guides/监控指标体系.md` | 其他文档引用章节 |
...
design/技术方案.md (系统设计)
    ├─→ design/数据库设计.md (数据层)
    ├─→ api/接口文档.md (接口层)
    └─→ security/OAuth绑定完整时序图.md (认证层)

user-stories/EP02-会员报名与支付.md (业务需求)
    ├─→ security/OAuth绑定完整时序图.md (详细时序)
    ├─→ security/支付安全增强方案.md (安全实施)
    └─→ design/状态枚举定义.md (状态规范)

guides/Stage1-支付闭环实施指南.md (实施计划)
    ├─→ user-stories/EP02-会员报名与支付.md (业务需求)
    ├─→ security/OAuth绑定完整时序图.md (技术细节)
...
1. 查看 [AI辅助敏捷开发计划](./guides/AI辅助敏捷开发计划.md) - 了解当前 Stage
2. 查看对应实施指南（如 [Stage1-支付闭环实施指南](./guides/Stage1-支付闭环实施指南.md)）
...
2. 应用 [缓存策略与性能优化](./guides/缓存策略与性能优化.md)
...
1. 使用 [开发前准备清单](./guides/开发前准备清单.md) - 环境配置
2. 配置 [监控指标体系](./guides/监控指标体系.md) - 监控告警
